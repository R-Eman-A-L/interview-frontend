<script lang="ts">
	...
	const DIFFICULTY_MODE = page.url.searchParams.get('mode') ?? 'chill';
	...
	async function onGenerateQuestions() {
		...
		try {
			...
			await goto(`/interview/${INTERVIEW_ID}?mode=${DIFFICULTY_MODE}`);
		} catch (e: any) {
...
<p>
	Paste your resume, notes, company extra informations, or the job description below. If you decide
	to leave this field empty, the questions will be generated using your setup informations only.
</p>
